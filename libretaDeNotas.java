...
public class libretaDeNotas {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2. Mostrar si la nota es aprueba o no la materia");
    ...
    private static void verificarAprobacionPorMateria(HashMap<String, HashMap<String, Double>> nombreEstudiante) {
        ...
        if (nombreEstudiante.containsKey(nombre)) {
            ...
            if (notas.containsKey(materia)) {
                ...
                if (nota >= 4.0) {
                    System.out.println("Nota aprobatoria en " + materia);
                } else {
                    System.out.println("Nota reprobatoria en " + materia);
                }
            } else {
